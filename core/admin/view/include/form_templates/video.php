        ...
        <div class="wq-block__wrap img_wrapper">
            ...
            <div class="wq-block__controls wq-controls">
                ...
                <?php if(!empty($this->data[$row]) && $this->showButtons()):?>
                    <a href="<?=$this->alias(['delete', $this->table => $this->data[$this->columns['id_row']], $row => base64_encode($this->data[$row])])?>" class="wq-controls__button wq-button wq-button_valencia _btn wq-delete">
                        удалить
                    </a>
                <?php endif;?>
            </div>
            <div class="wq-block__img-view _ibg img_show main_img_show">
                <?php if(!empty($this->data[$row])):?>
                    <video src="<?=$this->img($this->data[$row])?>" controls="controls"></video>
                <?php endif;?>
            </div>
        </div>
    </div>
